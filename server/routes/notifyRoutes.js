      ...
      <div style="font-family:Poppins,Arial,sans-serif;background:#f6f8fa;padding:16px;color:#333;">
        <div style="max-width:720px;margin:0 auto;background:#ffffff;overflow:hidden;border:1px solid #ececec;">
          ...
          <div style="padding:22px 24px;line-height:1.6;background:#ffffff;">
            ...
            <h3 style="color:#1d173c;text-align:center;margin:10px 0;font-size:16px;">${tempId}</h3>

            <p style="margin:0 0 10px;font-size:14px;">To complete your shipment process, please ensure that the required payment has been made. Once payment is confirmed, your parcel will be processed and scheduled for dispatch.</p>

            <p style="margin:0 0 10px;font-size:14px;"><strong>Kindly reply directly to this email</strong> to confirm your payment or request payment instructions.</p>
            ...
            <p style="margin:0;font-size:14px;color:#555;">Need help? Contact us at <a href="mailto:customerline@rapidroutes.com" style="color:#d84659;text-decoration:none;">customerline@rapidroutes.com</a></p>
          </div>
          ...
          <div style="background:#1d173c;color:#fff;padding:18px 20px;text-align:center;font-size:13px;">
            <div style="max-width:640px;margin:0 auto;">
              ...
              <div style="color:#c9c9d9;font-size:13px;line-height:1.6;">We are dedicated to providing fast, secure and reliable delivery solutions. For support, email <a href="mailto:customerline@rapidroutes.com" style="color:#fff;text-decoration:underline;">customerline@rapidroutes.com</a></div>
            </div>
          </div>
